create database banking_system_project_1

use banking_system_project_1
...
create procedure dbo.paystatement( @month int, @accoutnumber bigint)
as
begin
	select* from TransactionDetail where DateofTransaction>=dateadd(month, -@month, getdate())
	and AccountNumber=@accoutnumber
end
